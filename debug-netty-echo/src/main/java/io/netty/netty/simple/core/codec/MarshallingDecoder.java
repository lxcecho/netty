...
public class MarshallingDecoder {
    ...
    protected Object decode(ByteBuf in) throws Exception {
        ...
        log.info("进行解码操作，首先获取数据总长度为： {}", objectSize);
        // 进行 slice 截取从读取位置开始为：in.readerIndex() 读取后 objectSize 的数据长度
        log.info("从 in.readerIndex()= {} 位置开始, 读取数据长度 objectSize={} 的数据！", in.readerIndex(), objectSize);
